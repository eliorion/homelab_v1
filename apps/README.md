...
```
asp/  audiobookshelf/  azuracast/  fbref/  glpi/  linkding/  monica/  n8n/  nextcloud/  paperclip/  scraper/
```
...
| paperclip | [`base/paperclip/README.md`](base/paperclip/README.md) — agent control plane, tailnet-only |
